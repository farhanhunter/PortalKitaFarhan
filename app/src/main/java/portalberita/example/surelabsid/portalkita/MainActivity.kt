package portalberita.example.surelabsid.portalkita

import com.surelabsid.lauwba.portalberita.R
...
import portalberita.example.surelabsid.portalkita.model.DataItem
import portalberita.example.surelabsid.portalkita.model.ResponseListBerita
import portalberita.example.surelabsid.portalkita.network.NetworkConfig
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setToAdapter(receivedDatas: List<DataItem?>?) {
        ...
        val adapter = NewsListAdapter(receivedDatas) {
            val detailNewsIntent = Intent(this@MainActivity, NewsListAdapter::class.java)
